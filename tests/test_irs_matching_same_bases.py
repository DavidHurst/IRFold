from irfold.util import ir_pair_match_same_bases, irs_match_same_bases
...
def test_method_irs_match_same_bases_irs_matching_same_bases(
    ...
    assert irs_match_same_bases(matching_the_same_bases_ir_pair) == True


def test_method_irs_match_same_bases_irs_not_matching_same_bases(
    not_matching_the_same_bases_ir_pair,
):
    assert irs_match_same_bases(not_matching_the_same_bases_ir_pair) == False
