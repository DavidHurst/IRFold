...
if __name__ == "__main__":
    """Evaluate the IR pairs found in a single sequence to see whether they form invalid loops"""
    ...
    found_irs = IRFoldBase.__find_irs(seq, out_dir=str(EXPERIMENT_1_DATA_DIR))
    n_irs = len(found_irs)
